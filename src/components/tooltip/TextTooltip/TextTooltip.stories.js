...
const Def = <div>
  <p>Something hereSomething hereSomething hereSomething hereSomething hereSomething hereSomething here</p>
  <p>Something here</p>
  <p>Something here</p>
  <p>Something here</p>
  <p>Something here</p>
...
const C = () => (
  <p style={{ backgroundColor: "rgb(var(--bg-4dp))", width: "5rem" }}>Another thing</p>
);
